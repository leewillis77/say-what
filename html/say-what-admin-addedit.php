...
<div class="wrap">
	...
	<form action="tools.php?page=say_what_admin&amp;say_what_action=addedit" method="post">
		...
		<p>
			<label for="say_what_domain"><?php _e( 'Text domain', 'say_what' ); ?></label> <a href="http://plugins.leewillis.co.uk/doc_post/adding-string-replacement/" target="_blank" tabindex="-1"><i class="dashicons dashicons-info">&nbsp;</i></a><br/>
			<input type="text" name="say_what_domain" size="30" value="<?php echo esc_attr( $replacement->domain ); ?>"><br/>
		</p>
		<p>
			<label for="say_what_context"><?php _e( 'Text context', 'say_what' ); ?></label> <a href="http://plugins.leewillis.co.uk/doc_post/replacing-wordpress-strings-context/" target="_blank" tabindex="-1"><i class="dashicons dashicons-info">&nbsp;</i></a><br/>
